...
# FASTQ generation, demultiplexing and alignment were analyzed by the Basecall software and CellRanger v6.0.1
# Next all data were processed via Seurat v4.0.3 in R v4.1.0.
# This file contains:
    1.Read data in & Create Seurat objects
    2.Pre-processing: quality control
        1)basic quality control of mitochondrial genes ratio, spurious features... 
        2)remove doublets
    3.Integrate all samples after pre-processing & cluster & annotation: 
...
#This is a process of testing the best parameters and runs slowly
...
####################################################################################################
################# Integrate all samples after pre-processing & cluster & annotation ################
